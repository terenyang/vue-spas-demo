          ...
          <div class="card bg-light">
            <div class="card-body">
              ...
              <section class="form-group">
                ...
                <input required class="form-control" type="text" placeholder="Name" v-model="displayName" />
              </section>
              <section class="form-group">
                <label class="form-control-label sr-only" for="Email">Email</label>
                <input required class="form-control" type="email" v-model="email" placeholder="Email" />
              </section>
